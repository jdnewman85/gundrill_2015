...
#define STATE_RETURN_ZERO	6
#define STATE_STOP		7
#define STATE_WAIT_COMPLETE	8
#define STATE_EMERGENCY_RETURN_START	9
#define STATE_OVERFLOW		10
...
#define OUTPUT_CYCLE_START	3
#define OUTPUT_FEED_FORWARD	4
#define OUTPUT_RAPID_RETRACT	5
